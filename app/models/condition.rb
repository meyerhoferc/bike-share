class Condition < ActiveRecord::Base
  ...
  def self.wind_maximum_rides
    ranges = [(0...4), (4...8), (8...12), (12...16), (16...20),
      ...
      phrase = counts.map { |count| "Wind Speed: #{count[:range]} miles per hour had a maximum of #{count[:count]} trips"}
  end
  ...
  def self.wind_minimum_rides
    ranges = [(0...4), (4...8), (8...12), (12...16), (16...20),
      ...
      phrase = counts.map { |count| "Wind Speed: #{count[:range]} miles per hour had a minimum of #{count[:count]} trips"}
  end
  ...
  def self.wind_average_rides
    ...
    phrase = counts.map { |count| "Wind Speed: #{count[:range]} miles per hour had an average of #{count[:average].to_i} trips"}
  end
end
